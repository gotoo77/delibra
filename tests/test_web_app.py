...
class WebAppTests(unittest.TestCase):
    ...
    def test_new_run_page_renders_provider_diagnostics_and_protocol_preview(self) -> None:
        ...
        self.assertIn("2 OpenAI models detected", response.text)
        ...
        self.assertIn("Source: presets/code_review.yaml", response.text)
        self.assertIn("id: code_review", response.text)
